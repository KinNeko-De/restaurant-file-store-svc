...
mockery --dir "%GOPATH%/pkg/mod/github.com/kinneko-de/api-contract/golang/kinnekode/restaurant@v0.0.3-store-files.6/file/v1" --name FileService_StoreRevisionServer --filename file_service_store_revision_server_mock.go --with-expecter --output ../../../test/testing/file --outpkg file
