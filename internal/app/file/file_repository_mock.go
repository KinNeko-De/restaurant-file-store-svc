...
func (_m *MockFileRepository) CreateFile(ctx context.Context, fileId uuid.UUID, chunkSize int) (io.WriteCloser, error) {
	ret := _m.Called(ctx, fileId, chunkSize)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, int) (io.WriteCloser, error)); ok {
		return rf(ctx, fileId, chunkSize)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, int) io.WriteCloser); ok {
		r0 = rf(ctx, fileId, chunkSize)
	} else {
		if ret.Get(0) != nil {
...
func (_e *MockFileRepository_Expecter) CreateFile(ctx interface{}, fileId interface{}, chunkSize interface{}) *MockFileRepository_CreateFile_Call {
	return &MockFileRepository_CreateFile_Call{Call: _e.mock.On("CreateFile", ctx, fileId, chunkSize)}
}
